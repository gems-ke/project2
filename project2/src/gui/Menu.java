...
public class Menu extends JFrame implements MouseListener {
	...
	public void initTreeStuff() {
                ...
                new ActionListener(){
                    public void actionPerformed(ActionEvent e){
                    	...
                    	for(int i = 0; i < columnNames.length; i++){
                    		if(!columnNames[i].equals("Datum") && !columnNames[i].equals("Name") && !columnNames[i].equals("Uhrzeit") && !columnNames[i].equals("Begr¸ndung"))
		...
		//TODO zeile hinzuf¸gen ¸berarbeiten!
	 ...
	 */
	//TODO addrowdata ¸berarbeiten f¸r neue tabledata konzept
		...
		for(int i = 0; i < tables.size(); i++){
			if(tables.get(i).equals(data[0])){
				for(int x = 0; x < tables.get(i).getColumnArray().length; x++){
					if(!tables.get(i).getColumnArray()[x].equals("Datum") && !tables.get(i).getColumnArray()[x].equals("Uhrzeit") && !tables.get(i).getColumnArray()[x].equals("Name") && !tables.get(i).getColumnArray()[x].equals("Begr¸ndung")){
